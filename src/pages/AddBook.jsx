...
export default function AddBook() {
  ...
  const inputClass = (field) =>
    `w-full bg-black border ${
      errors[field] ? "border-red-500" : "border-pink-700"
    } focus:border-pink-500 text-pink-100 placeholder-pink-600/50 text-sm rounded-xl px-4 py-3 outline-none transition-all duration-200`;
    ...
    <div className="min-h-screen bg-black px-6 py-10">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="mt-3 w-12 h-1 bg-pink-500 rounded-full" />
        </div>

        <form
          onSubmit={handleSubmit}
          className="bg-black/40 border border-pink-800 rounded-3xl p-8 flex flex-col gap-5"
        >
          <div>
            <label className="text-pink-300 text-sm font-semibold mb-1 block">
          ...
          <div className="flex items-center gap-4 pt-2">
            <button
              type="submit"
              className="flex-1 bg-pink-500 hover:bg-pink-400 text-pink-950 font-bold text-sm py-3 rounded-full transition-all duration-200 hover:scale-105 shadow-lg"
            >
              + Add Book
            </button>
            <button
              ...
              className="flex-1 border border-pink-700 hover:border-pink-500 text-pink-400 hover:text-pink-300 font-bold text-sm py-3 rounded-full transition-all duration-200"
            >
              Reset
            </button>
          </div>
